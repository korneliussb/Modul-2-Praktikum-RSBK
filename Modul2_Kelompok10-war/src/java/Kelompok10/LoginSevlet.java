...
//        }
            ...
            stNim  = validasiSession.nim(nim);
                if (stNim && stNama){
                    ...
                    if (loginSession.isLoginStatus()) {
                        ...
                        request.setAttribute("namaMahasiswa", request.getParameter("nama")); //menambahkan nama tiap sesi
                        RequestDispatcher rd = getServletContext().getRequestDispatcher("/LoginView.jsp");
                        rd.forward(request, response);
                    } else {
                        request.setAttribute("status", "false");
    ...
    private LoginSessionLocal lookupLoginSessionLocal() {
        try {
            ...
            return (LoginSessionLocal) c.lookup("java:global/Modul2_Kelompok10/Modul2_Kelompok10-ejb/LoginSession!Kelompok10.LoginSessionLocal");
